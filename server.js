...
// parse the json data (client side)
...
app.post("/login",(req,res)=>{
    ashokIT.connect("mongodb+srv://admin:admin@miniprojectdb.nzphu.mongodb.net/ecommerce?retryWrites=true&w=majority",
    (err,conn)=>{
        if(err) throw err;
        else{
...
// http://localhost:8080/category/laptop
